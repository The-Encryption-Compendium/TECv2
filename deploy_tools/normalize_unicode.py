...
'''
Normalize Unicode in the given file.
'''
...
parser.add_argument("--form", default="NFKC",
                    help="choose the preferred Unicode normal form (default: NFKC)")
...
if __name__ == "__main__":
    ...
    if normed is not None:
        ...
        info(f"normalization to {args.form} had an effect, overwriting {args.infile}"
             "(backed up to {args.infile}.unnormalized)")
