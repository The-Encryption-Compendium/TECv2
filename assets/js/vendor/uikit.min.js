    ...
    (Ui.extend = function (t) {
      ...
      return (
        (((e.prototype = Object.create(
          this.prototype
        )).constructor = e).options = _i(this.options, t)),
        (e.super = this),
      ...
      update: [
        {
          read: function (t) {
            var e = t.height;
            this.isActive &&
              (this.hide(), (e = this.$el.offsetHeight), this.show()),
              (e = this.isActive ? e : this.$el.offsetHeight),
              (this.topOffset = si(
                this.isFixed ? this.placeholder : this.$el
              ).top),
              (this.bottomOffset = this.topOffset + e);
            var i = br("bottom", this);
            return (
              (this.top =
              ...
              if ("image" === e || n.match(/\.(jpe?g|png|gif|svg|webp)($|\?)/i))
                de(n, a.srcset, a.size).then(
                  function (t) {
                    ...
                    return o.setItem(
                      r,
                      Rr("img", G({ src: n, width: e, height: i, alt: s }, a))
                    );
                  },
                  function () {
                    return o.setError(r);
                ...
                Yt(c, "loadedmetadata", function () {
                  ot(c, { width: c.videoWidth, height: c.videoHeight }),
                    o.setItem(r, c);
                }),
                  Yt(c, "error", function () {
                    return o.setError(r);
